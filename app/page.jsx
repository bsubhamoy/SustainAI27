...
<div className="homeBgImage" aria-hidden="true"/><div className="homeGlow homeGlowA"/><div className="homeGlow homeGlowB"/><div className="homeCircuits"><span/><span/><span/><span/><span/></div>
...
<div className="homeIntro"><div className="homeLogo"><Image src="/assets/sustainai-at-logo.svg" alt="Sust@inAI 27 logo" width={220} height={280} priority/></div><div className="homeIntroText"><div className="homeLabel">CONFERENCE INTRODUCTION</div><h3>Intelligence that works with the planet.</h3><p><b>Sust@inAI 27</b> is the International Conference on Sustainable Artificial Intelligence and Green Computing, bringing the AI and sustainable-computing communities together around one question: <b>how do we advance artificial intelligence without accelerating its environmental cost?</b></p><p>The conference welcomes work spanning energy-efficient AI systems, green computing infrastructure, and AI applied to environmental challenges — alongside the policy and reporting standards needed to make sustainability claims verifiable, taking place in Sydney from <b>20th–22nd April, 2027.</b></p></div></div>
<div className="homeCountdown"><div className="homeLabel">◷ &nbsp; COUNTDOWN TO SUST@INAI 27</div><Countdown/><div className="homePartners"><Image src="/assets/iem-logo.svg" alt="Institute of Engineering and Management" width={120} height={100}/><Image src="/assets/smart-society-logo.svg" alt="SMART Society" width={160} height={50}/></div></div>
</div>
